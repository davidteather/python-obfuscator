...
class VariableNameGenerator:
    def __init__(self):
        self.generator_options = [self.random_string, self.l_and_i, self.time_based, self.just_id, self.scream, self.single_letter_a_lot]
    ...
    def random_string(self, id, length=79):
        ...
        return ''.join(random.choice(string.ascii_lowercase) for i in range(length)) + str(id)
